...
freqs_ampl = numpy.load(storepath+'/freqs_for_amplitude_array.npy')
amps_array  = numpy.load(storepath+'/'+calname+'_amplitude_array.npy')
clock_array = numpy.load(storepath+'/fitted_data_dclock_'+calname+'_1st.sm.npy')

freqs_phase = numpy.load('{path}/freqs_for_phase_array.npy'.format(path=storepath))
phases_array  = numpy.load(storepath+'/'+calname+'_phase_array.npy'.format(path=storepath))   #freq, stat
...
for ms in mslist:
 ...
 pdb   = lofar.parmdb.parmdb('{path}/instrument_template_caltransfer'.format(path=storepath))
